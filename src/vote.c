...
{
	docmdtitle("[Í¶Æ±ÏäÁĞ±í]", "[\033[1;32m¡û\033[m,\033[1;32me\033[m] Àë¿ª "
			"[\033[1;32mh\033[m] ÇóÖú [\033[1;32m¡ú\033[m,\033[1;32mr <cr>"
			"\033[m] ½øĞĞÍ¶Æ± [\033[1;32m¡ü\033[m,\033[1;32m¡ı\033[m] ÉÏ,ÏÂÑ¡Ôñ"
			" \033[1m¸ßÁÁ¶È\033[m±íÊ¾ÉĞÎ´Í¶Æ±\n"
			"\033[1;44m±àºÅ ¿ªÆôÍ¶Æ±ÏäÕß ¿ªÆôÈÕ Í¶Æ±Ö÷Ìâ"
			"                                Àà±ğ ÌìÊı ÈËÊı\033[m\n");
}
...
int b_vote2(void)
{
	...
	if (num == 0) {
		presskeyfor("±§Ç¸, Ä¿Ç°²¢Ã»ÓĞÈÎºÎÍ¶Æ±¾ÙĞĞ¡£", t_lines - 1);
		return FULLUPDATE;
	}
