...
//¶ÔÓÚ»Ø¸´ºÍ·¢ÐÅ£¬title³õÊ¼²»Îª¿Õ.ËùÒÔÖ»ÓÐÔÚ·¢±íÎÄÕÂÊ±£¬²Å»á³öÏÖ"[ÕýÔÚÉè¶¨Ö÷Ìâ]"
		...
		sprintf(mybuf,
 		     "[1;32m0[m~[1;32m%d V[m¿´Ç©Ãûµµ%s [1;32mX[mËæ»úÇ©Ãûµµ,[1;32mT[m±êÌâ%s%s%s,[1;32mQ[m·ÅÆú:",
			numofsig, (header->reply_mode) ? ",[1;32mS[m/[1;32mY[m/[1;32mN[m/[1;32mR[m/[1;32mA[m ÒýÑÔÄ£Ê½" : "", (anonyboard) ? "£¬[1;32mL[mÄäÃû" : "",(header->postboard)?",[1;32mU[mÊôÐÔ":"",(header->postboard&&header->reply_mode)?",[1;32mM[m¼ÄÐÅ":"");
#endif
...
//´Ë·½·¨Î´±»Ê¹ÓÃ£¬Ö÷ÒªÓÃÓÚ¼ì²éµ±Ç°°æÃæÊÇ·ñÎªÄäÃû
