...
//ÓÃÀ´±£´æÈÕÆÚ×Ö·û´®,ÈçÄêÔÂÈÕÖÜÊ±·ÖÃëµÈÖ®ÀàµÄ¸ñÊ½
char datestring[30];
...
int x_lockscreen() {
	...
	prints("\n[1;36mÆÁÄ»ÒÑÔÚ[33m %s[36m Ê±±»%sÔİÊ±Ëø×¡ÁË...[m", datestring,
			currentuser.userid);
	nice(19);
...
//      ½«ÕûÊınowµÄ¾ßÌåÈÕÆÚ±£´æÔÚdatastringÖĞ,modeÎª1ÔòÓ¢,Îª0Ôòºº
//      modeÎª2ÔòÖ»±£´æÔÂ,ÈÕ,Ê±,·Ö
//      ·µ»ØÖµÎªÃëÊı/10
